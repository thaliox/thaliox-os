...
| | M4 cluster + multi-platform | agent↔agent + team orchestration + multi-platform clients | delivers F7/F8 → Series A — **🚧 in progress: design [RFC-0006](rfcs/0006-cluster-multiplatform.md); fabric VectorMessage transport → distributed HA (M3 over the network) → teams → clients** |
